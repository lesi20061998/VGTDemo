...
return [
    ...
    [
        'title' => 'Tính năng Frontend',
        'description' => 'Popup, thông báo ảo, button liên hệ, thống kê',
        'icon' => 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',
        'color' => 'purple',
        'route' => 'cms.settings.frontend-features',
        'permission' => 'settings.frontend_features',
    ],
    [
        'title' => 'Form đăng ký',
