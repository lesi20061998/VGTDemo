...
function mediaManager() {
    return {
        ...
        newFolderName: '',
        baseUrl: '<?php echo e(request()->route("projectCode") ? "/" . request()->route("projectCode") . "/admin" : "/admin"); ?>',
...
<?php /**PATH C:\xampp\htdocs\core_laravel\Core_system\resources\views/cms/components/media-manager.blade.php ENDPATH**/ ?>