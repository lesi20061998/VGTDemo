...
<div x-data="mediaPickerModal('<?php echo e($id); ?>', <?php echo e($multiple ? 'true' : 'false'); ?>, '<?php echo e($mediaListUrl); ?>', '<?php echo e($mediaUploadUrl); ?>', '<?php echo e($mediaDeleteUrl); ?>')"
     x-show="isOpen"
     x-cloak
...
<?php /**PATH C:\xampp\htdocs\core_laravel\Core_system\resources\views/components/media-picker-modal.blade.php ENDPATH**/ ?>