...
<?php echo $__env->make('cms.components.alert', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg shadow-sm p-4 mb-6 text-white">
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h1 class="text-xl font-bold">Dự án: <?php echo e(strtoupper($currentProject->code ?? request()->route('projectCode'))); ?></h1>
        ...
        <div class="flex items-center space-x-4 text-sm">
            <div class="bg-white/20 rounded-lg px-3 py-2">
                ...
                <span class="font-mono">project_<?php echo e(strtolower($currentProject->code ?? request()->route('projectCode'))); ?></span>
            </div>
            <div class="bg-white/20 rounded-lg px-3 py-2">
                <span class="font-medium">Ngôn ngữ:</span> 
                <span class="font-bold">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($languageId ?? 1) == 1): ?> Tiếng Việt
                    <?php elseif(($languageId ?? 1) == 2): ?> English  
                    <?php elseif(($languageId ?? 1) == 3): ?> 中文
                    <?php else: ?> ID: <?php echo e($languageId ?? 1); ?>
            ...
            <div class="bg-white/20 rounded-lg px-3 py-2">
                ...
                <span class="font-bold"><?php echo e($products->total()); ?></span>
            </div>
        </div>
    </div>
</div>
...
<div class="flex justify-between items-center mb-6">
    <div class="flex space-x-4">
        <form method="GET" class="flex space-x-2">
            ...
            <select name="language_id" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                <option value="1" <?php echo e(($languageId ?? 1) == 1 ? 'selected' : ''); ?>>Tiếng Việt (Mặc định)</option>
                <option value="2" <?php echo e(($languageId ?? 1) == 2 ? 'selected' : ''); ?>>English</option>
                <option value="3" <?php echo e(($languageId ?? 1) == 3 ? 'selected' : ''); ?>>中文</option>
            </select>
            ...
            <select name="category" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $parentCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <optgroup label="<?php echo e($parent->name); ?>">
                        <option value="<?php echo e($parent->id); ?>" <?php echo e(request('category') == $parent->id ? 'selected' : ''); ?>>-- <?php echo e($parent->name); ?> (Tất cả)</option>
    ...
    <div class="flex space-x-2">
        ...
        <a href="<?php echo e(route('project.admin.categories.index', request()->route('projectCode'))); ?>" 
        ...
        <a href="<?php echo e(route('project.admin.products.create', request()->route('projectCode'))); ?>" 
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-blue-500">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                ...
                <p class="text-2xl font-semibold text-gray-900"><?php echo e($products->total()); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-green-500">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                ...
                <p class="text-2xl font-semibold text-gray-900"><?php echo e($products->where('status', 'published')->count()); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-yellow-500">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                ...
                <p class="text-2xl font-semibold text-gray-900"><?php echo e($products->where('status', 'draft')->count()); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-purple-500">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                ...
                <p class="text-2xl font-semibold text-gray-900"><?php echo e($parentCategories->count()); ?></p>
            </div>
        </div>
    </div>
</div>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                    <input type="checkbox" class="product-checkbox rounded border-gray-300 text-blue-600" value="<?php echo e($product->id); ?>">
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-10 w-10">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->featured_image): ?>
                                <img class="h-10 w-10 rounded-full object-cover" src="<?php echo e($product->featured_image); ?>" alt="">
                            <?php else: ?>
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-sm text-gray-500"><?php echo e(Str::limit($product->short_description, 50)); ?></div>
                            <div class="flex items-center space-x-2 mt-1">
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">
                                    ...
                                    <?php echo e(strtoupper($currentProject->code ?? request()->route('projectCode'))); ?>
                            ...
                            <div class="flex items-center space-x-2 mt-2">
                                ...
                                <!-- Featured Toggle -->
                                <button onclick="toggleBadge(<?php echo e($product->id); ?>, 'featured')" 
                                        class="inline-flex items-center justify-center w-9 h-9 rounded <?php echo e($product->is_featured ? 'bg-yellow-200 text-yellow-800' : 'bg-gray-100 text-gray-400'); ?> hover:bg-yellow-300 transition-colors" 
                                        title="Nổi bật">
                                ...
                                <!-- Favorite Toggle -->
                                <button onclick="toggleBadge(<?php echo e($product->id); ?>, 'favorite')" 
                                        class="inline-flex items-center justify-center w-9 h-9 rounded <?php echo e($product->is_favorite ? 'bg-red-200 text-red-800' : 'bg-gray-100 text-gray-400'); ?> hover:bg-red-300 transition-colors" 
                                        title="Yêu thích">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <!-- Bestseller Toggle -->
                                <button onclick="toggleBadge(<?php echo e($product->id); ?>, 'bestseller')" 
                                        class="inline-flex items-center justify-center w-9 h-9 rounded <?php echo e($product->is_bestseller ? 'bg-green-200 text-green-800' : 'bg-gray-100 text-gray-400'); ?> hover:bg-green-300 transition-colors" 
                                        title="Bán chạy">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <td class="px-6 py-4 text-sm text-gray-500">
                    <!-- Categories -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->categories && $product->categories->count() > 0): ?>
                        <div class="mb-2">
                            <div class="text-xs font-medium text-gray-600 mb-1">Danh mục:</div>
                            <div class="flex flex-wrap gap-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $product->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">
                    ...
                    <!-- Brands -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->brands && $product->brands->count() > 0): ?>
                        <div class="mb-2">
                            <div class="text-xs font-medium text-gray-600 mb-1">Thương hiệu:</div>
                            <div class="flex flex-wrap gap-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $product->brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!-- Summary -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($product->categories && $product->categories->count() > 0) || ($product->brands && $product->brands->count() > 0)): ?>
                        <div class="text-xs text-gray-400">
                            <?php echo e($product->categories->count() ?? 0); ?> danh mục, <?php echo e($product->brands->count() ?? 0); ?> thương hiệu
                        </div>
                    <?php else: ?>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                        <?php echo e($product->stock_status === 'in_stock' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                        <?php echo e($product->status === 'published' ? 'bg-green-100 text-green-800' : 
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div class="flex items-center space-x-1">
                        <!-- Quick Edit -->
                        <button onclick="openSingleQuickEdit(<?php echo e($product->id); ?>)" 
                        ...
                        <!-- Edit -->
                        <a href="<?php echo e(route('project.admin.products.edit', [request()->route('projectCode'), $product])); ?>" 
                        ...
                        <!-- Delete -->
                        <form method="POST" action="<?php echo e(route('project.admin.products.destroy', [request()->route('projectCode'), $product])); ?>" class="inline">
                ...
                <td colspan="8" class="px-6 py-12 text-center">
                    <div class="flex flex-col items-center justify-center space-y-4">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-500 mb-4">Dự án <strong><?php echo e(strtoupper($currentProject->code ?? request()->route('projectCode'))); ?></strong> chưa có sản phẩm nào được tạo.</p>
                            <a href="<?php echo e(route('project.admin.products.create', request()->route('projectCode'))); ?>" 
...
function openBulkEdit() {
    ...
    const bulkEditUrl = '<?php echo e(route("project.admin.products.bulk-edit", request()->route("projectCode"))); ?>';
...
function saveBulkEdit() {
    ...
    // Always use project route
    const bulkUpdateUrl = '<?php echo e(route("project.admin.products.bulk-update", request()->route("projectCode"))); ?>';
...
function toggleBadge(productId, badgeType) {
    ...
    // Always use project route
    const toggleUrl = '<?php echo e(route("project.admin.products.toggle-badge", request()->route("projectCode"))); ?>';
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\core_laravel\Core_system\resources\views/admin/products/index.blade.php ENDPATH**/ ?>