<?php $__env->startSection('title', 'Quản lý Menu'); ?>
<?php $__env->startSection('page-title', 'Quản lý Menu'); ?>
...
<div class="grid grid-cols-12 gap-4">
    ...
    <div class="col-span-3 bg-white rounded-lg shadow-sm p-4">
        ...
        <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(url(request()->segment(1) . '/admin/menus/' . $menu->id)); ?>" class="flex-1 p-3 rounded-lg hover:bg-gray-50 <?php echo e($selectedMenu && $selectedMenu->id == $menu->id ? 'bg-blue-50 border-l-4 border-blue-600' : 'border-l-4 border-transparent'); ?>">
                    <div class="font-medium"><?php echo e($menu->name); ?></div>
                    <div class="text-xs text-gray-500">
                        <?php echo e($menu->allItems->count()); ?> mục
                    </div>
                </a>
                <button onclick="deleteMenu(<?php echo e($menu->id); ?>)" class="p-2 text-red-600 hover:bg-red-50 rounded" title="Xóa menu">
    ...
    <div class="col-span-4 bg-white rounded-lg shadow-sm p-4">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedMenu): ?>
        <div class="space-y-4">
            <!-- Trang Nội Dung -->
            <div class="border rounded-lg">
                ...
                <div id="pages-section" class="p-3 border-t max-h-60 overflow-y-auto">
                    ...
                    <label class="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                        <input type="checkbox" class="mr-2" data-type="page" data-id="<?php echo e($page->id); ?>" data-title="<?php echo e($page->title); ?>">
                        <span class="text-sm"><?php echo e($page->title); ?></span>
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="border rounded-lg">
                ...
                <div id="product-categories-section" class="hidden p-3 border-t max-h-60 overflow-y-auto">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($productCategories) && $productCategories->count() > 0): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $productCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-2">
                        <label class="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer font-medium">
                            <input type="checkbox" class="mr-2" data-type="productcategory" data-id="<?php echo e($category->id); ?>" data-title="<?php echo e($category->name); ?>">
                            <span class="text-sm"><?php echo e($category->name); ?></span>
                        </label>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category->children && $category->children->count() > 0): ?>
                        <div class="ml-6 space-y-1">
                            ...
                            <label class="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                                <input type="checkbox" class="mr-2" data-type="productcategory" data-id="<?php echo e($child->id); ?>" data-title="<?php echo e($child->name); ?>">
                                <span class="text-sm text-gray-600">↳ <?php echo e($child->name); ?></span>
                            </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
    ...
    <div class="col-span-5 bg-white rounded-lg shadow-sm p-4">
        ...
        <div class="flex justify-between items-center mb-4">
            <h3 class="font-semibold text-lg"><?php echo e($selectedMenu->name); ?></h3>
            <div class="flex gap-2">
                ...
                <button onclick="deleteMenu(<?php echo e($selectedMenu->id); ?>)" class="px-3 py-1 text-red-600 hover:bg-red-50 rounded">Xóa menu</button>
            </div>
        </div>
        
        <div id="menu-structure" class="min-h-[400px] sortable-menu">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedMenu->allItems && $selectedMenu->allItems->count() > 0): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $selectedMenu->allItems->sortBy('order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $depth = 0;
                        $current = $item;
                    ...
                    ?>
                    <?php echo $__env->make('cms.menus.partials.menu-item', ['item' => $item, 'depth' => $depth], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php else: ?>
...
function addMenuItem(data) {
    ...
    const currentPath = window.location.pathname;
    const baseUrl = currentPath.replace(/\/menus.*/, '/menus');
    fetch(`${baseUrl}/<?php echo e($selectedMenu->id); ?>/items`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
function updateMenuOrder() {
    ...
    const currentPath = window.location.pathname;
    const baseUrl = currentPath.replace(/\/menus.*/, '/menus');
    fetch(`${baseUrl}/<?php echo e($selectedMenu->id ?? 0); ?>/update-tree`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('cms.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\core_laravel\Core_system\resources\views/cms/menus/index.blade.php ENDPATH**/ ?>