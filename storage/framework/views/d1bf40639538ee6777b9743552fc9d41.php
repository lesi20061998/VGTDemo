...
<?php $__env->startSection('title', 'Widget Builder'); ?>
<?php $__env->startSection('page-title', 'Widget Builder - Drag & Drop'); ?>
...
<?php if (isset($component)) { $__componentOriginaldb5eb00895c7f977c5e28faab8fe69b3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldb5eb00895c7f977c5e28faab8fe69b3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.media-picker-modal','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('media-picker-modal'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginaldb5eb00895c7f977c5e28faab8fe69b3)): ?>
<?php $attributes = $__attributesOriginaldb5eb00895c7f977c5e28faab8fe69b3; ?>
<?php unset($__attributesOriginaldb5eb00895c7f977c5e28faab8fe69b3); ?>
<?php endif; ?>
<?php if (isset($__componentOriginaldb5eb00895c7f977c5e28faab8fe69b3)): ?>
<?php $component = $__componentOriginaldb5eb00895c7f977c5e28faab8fe69b3; ?>
<?php unset($__componentOriginaldb5eb00895c7f977c5e28faab8fe69b3); ?>
<?php endif; ?>
    ...
    <div class="w-80 flex-shrink-0 bg-white rounded-lg shadow-sm flex flex-col overflow-hidden">
        <div class="p-4 border-b bg-gray-50">
            <h3 class="font-bold text-lg flex items-center justify-between">
                ...
                <span class="bg-blue-500 text-white text-xs px-2 py-1 rounded-full"><?php echo e(array_sum(array_map('count', $availableWidgets))); ?></span>
            </h3>
        ...
        <div class="flex-1 overflow-y-auto p-3 space-y-3" id="widgetTemplatesList">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableWidgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $widgets): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="widget-category" data-category="<?php echo e($category); ?>">
                <button type="button" onclick="toggleCategory('<?php echo e($category); ?>')" 
                        class="w-full flex items-center justify-between p-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition">
                    <span class="font-medium text-sm flex items-center gap-2">
                        <svg class="w-4 h-4 transition-transform category-arrow" id="arrow-<?php echo e($category); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                        <?php echo e(ucfirst(str_replace('_', ' ', $category))); ?>

                    </span>
                    <span class="bg-blue-100 text-blue-700 text-xs px-2 py-0.5 rounded-full"><?php echo e(count($widgets)); ?></span>
                </button>
                
                <div class="category-content mt-2 space-y-2" id="category-<?php echo e($category); ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $widgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $widget): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="widget-template border border-gray-200 rounded-lg p-3 cursor-move hover:border-blue-400 hover:bg-blue-50 hover:shadow-sm transition-all" 
                         draggable="true" 
                         data-type="<?php echo e($widget['type']); ?>"
                         data-name="<?php echo e($widget['metadata']['name'] ?? $widget['name']); ?>"
                         data-category="<?php echo e($category); ?>"
                         title="<?php echo e($widget['metadata']['description'] ?? $widget['description'] ?? 'No description'); ?>">
                        <div class="flex items-center gap-2">
                            <div class="w-8 h-8 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg flex items-center justify-center flex-shrink-0">
                                <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <?php echo $widget['icon'] ?? '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/>'; ?>

                                </svg>
                            </div>
                            <div class="flex-1 min-w-0">
                                <h4 class="font-medium text-sm truncate"><?php echo e($widget['metadata']['name'] ?? $widget['name']); ?></h4>
                                <p class="text-xs text-gray-500 truncate"><?php echo e($widget['type']); ?></p>
                            </div>
...
existingWidgetsGrouped = <?php echo json_encode($existingWidgets ?? [], 15, 512) ?>;
...
function previewWidget() {
    ...
    fetch('<?php echo e(route("cms.widgets.preview")); ?>', {
        method: 'POST',
        headers: {
...
function renderConfigForm(widget) {
    ...
    const fieldsUrl = '<?php echo e(isset($currentProject) ? route("project.admin.widgets.fields", $currentProject->code) : route("cms.widgets.fields")); ?>';
...
async function saveWidgets(e) {
    ...
    const baseUrl = '<?php echo e(isset($currentProject) ? route("project.admin.widgets.save-all", $currentProject->code) : route("cms.widgets.save-all")); ?>';
...
<?php echo $__env->make('cms.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\core_laravel\Core_system\resources\views/cms/widgets/builder.blade.php ENDPATH**/ ?>