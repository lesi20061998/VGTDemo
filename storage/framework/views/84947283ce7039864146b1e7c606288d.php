...
<body class="bg-gray-100" x-data="{ showAlert: false, alertMessage: '', alertType: 'success' }">
    ...
    <div class="min-h-screen flex w-full">
        ...
        <div id="sidebar" class="w-72 bg-slate-800 shadow-2xl transition-all duration-300 fixed h-screen overflow-y-auto">
            ...
            <nav class="mt-6 px-3">
                <!-- Dashboard -->
                <a href="<?php echo e(route('project.admin.dashboard', request()->route('projectCode'))); ?>" class="nav-item flex items-center px-4 py-3 mb-2 text-slate-300 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('project.admin.dashboard') ? 'bg-[#98191F] text-white shadow-lg' : ''); ?>">
                ...
                <div class="mb-4">
                    <div class="dropdown-parent">
                        ...
                        <div class="dropdown-menu ml-4 space-y-1 max-h-0 overflow-hidden transition-all duration-300">
                            <a href="<?php echo e(route('project.admin.products.index', request()->route('projectCode'))); ?>" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('project.admin.products.*') ? 'bg-[#98191F] text-white' : ''); ?>">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                                </svg>
                                <span class="text-sm nav-text">Sản phẩm</span>
                            </a>
                            <a href="<?php echo e(route('project.admin.categories.index', request()->route('projectCode'))); ?>" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('project.admin.categories.*') ? 'bg-[#98191F] text-white' : ''); ?>">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                                </svg>
                                <span class="text-sm nav-text">Danh mục</span>
                            </a>
                            <a href="<?php echo e(route('project.admin.brands.index', request()->route('projectCode'))); ?>" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('project.admin.brands.*') ? 'bg-[#98191F] text-white' : ''); ?>">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                                </svg>
                                <span class="text-sm nav-text">Thương hiệu</span>
                            </a>
                            <a href="<?php echo e(route('project.admin.attributes.index', request()->route('projectCode'))); ?>" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('project.admin.attributes.*') ? 'bg-[#98191F] text-white' : ''); ?>">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h8m-8 6h16"></path>
                                </svg>
                                <span class="text-sm nav-text">Thuộc tính</span>
                            </a>
                            <a href="<?php echo e(route('project.admin.orders.index', request()->route('projectCode'))); ?>" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('project.admin.orders.*') ? 'bg-[#98191F] text-white' : ''); ?>">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mb-4">
                    <div class="dropdown-parent">
                        ...
                        <div class="dropdown-menu ml-4 space-y-1 max-h-0 overflow-hidden transition-all duration-300">
                            <a href="<?php echo e(route('project.admin.posts.index', request()->route('projectCode'))); ?>" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('project.admin.posts.*') ? 'bg-[#98191F] text-white' : ''); ?>">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path>
                                </svg>
                                <span class="text-sm nav-text">Bài viết</span>
                            </a>
                            <a href="<?php echo e(route('project.admin.pages.index', request()->route('projectCode'))); ?>" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('project.admin.pages.*') ? 'bg-[#98191F] text-white' : ''); ?>">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                            ...
                            <a href="<?php echo e(route('project.admin.media.list', request()->route('projectCode'))); ?>" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('project.admin.media.*') ? 'bg-[#98191F] text-white' : ''); ?>">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="text-right">
                                <p class="text-sm font-medium text-gray-900"><?php echo e($currentUser->name ?? 'User'); ?></p>
                                <p class="text-xs text-gray-500">Administrator</p>
                            </div>
                            <div class="h-8 w-8 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full flex items-center justify-center">
                                <span class="text-white text-sm font-medium"><?php echo e(substr($currentUser->name ?? 'U', 0, 1)); ?></span>
                            </div>
                            <form method="POST" action="<?php echo e(isset($currentProject) ? route('project.logout', $currentProject->code) : route('logout')); ?>"></form>
                                <?php echo csrf_field(); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('alert')): ?>
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            showAlert('<?php echo e(session('alert')['message']); ?>', '<?php echo e(session('alert')['type']); ?>');
                        });
                    </script>
...
<?php /**PATH C:\xampp\htdocs\core_laravel\Core_system\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>