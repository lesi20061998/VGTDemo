...
Route::prefix('{projectCode}')
    ->name('project.')
    ->middleware([\App\Http\Middleware\ProjectSubdomainMiddleware::class, \App\Http\Middleware\SetProjectDatabase::class])
    ->group(function () {
...
// Middleware: auth + CheckCmsRole
// ============================================
Route::prefix('{projectCode}/admin')
    ->name('project.admin.')
    ->middleware([\App\Http\Middleware\ProjectSubdomainMiddleware::class, \App\Http\Middleware\SetProjectDatabase::class, 'auth', \App\Http\Middleware\CheckCmsRole::class])
    ->group(function () {
