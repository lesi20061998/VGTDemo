    ...
    <div class="footer__inner l-container l-pd-0-135px">
        ...
        <div class="footer-mid">
            <div class="footer__brand-info">
                <div class="footer__logo">
                    <img src="{{ $logoFooter }}" alt="Victorious Cruise Logo">
                </div>
            </div>
            <div class="footer__contact-grid">
                <div class="footer__contact-col">
                    <h3 class="footer__contact-title">HEADQUARTER</h3>
                    <p class="footer__contact-detail">Address: {{ $hqAddress }}</p>
                    <p class="footer__contact-detail">Phone: {{ $hqPhone }}</p>
                    <p class="footer__contact-detail">Hotline: {{ $hqHotline }}</p>
                    <p class="footer__contact-detail">Email: {{ $hqEmail }}</p>
                </div>
                <div class="footer__contact-col">
                    <h3 class="footer__contact-title">HALONG OFFICE</h3>
                    <p class="footer__contact-detail">Address: {{ $hlAddress }}</p>
                    <p class="footer__contact-detail">Phone: {{ $hlPhone }}</p>
                    <p class="footer__contact-detail">Hotline: {{ $hlHotline }}</p>
                </div>
            </div>
        </div>
        <div class="footer__social-media">
            ...
            <div class="footer__social-links">
                ...
                <a href="{{ $fb }}" class="footer__social-icon" aria-label="Facebook">
                    <img src="{{ asset('themes/victorious/img/icon/fb-ic.svg') }}" alt="">
                </a>
                @endif
                @if($ig = setting('social_instagram'))
                <a href="{{ $ig }}" class="footer__social-icon" aria-label="Instagram">
                    <img src="{{ asset('themes/victorious/img/icon/ins-ic.svg') }}" alt="">
                </a>
                @endif
                @if($tg = setting('social_telegram'))
                <a href="{{ $tg }}" class="footer__social-icon" aria-label="Telegram">
                    <img src="{{ asset('themes/victorious/img/icon/tele-ic.svg') }}" alt="">
                </a>
                @endif
                @if($yt = setting('social_youtube'))
                <a href="{{ $yt }}" class="footer__social-icon" aria-label="Youtube">
                    <img src="{{ asset('themes/victorious/img/icon/ytb-ic.svg') }}" alt="">
                </a>
                @endif
                @if($tw = setting('social_twitter'))
                <a href="{{ $tw }}" class="footer__social-icon" aria-label="X (Twitter)">
                    <img src="{{ asset('themes/victorious/img/icon/x-ic.svg') }}" alt="">
                </a>
                @endif
            </div>
        </div>
