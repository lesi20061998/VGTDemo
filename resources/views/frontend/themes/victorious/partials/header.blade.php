            ...
            <div class="details l-container">
                <div class="c-header__mail">
                    <a href="tel:{{ preg_replace('/\s+/', '', $phone) }}">
                        <img src="{{ asset('themes/victorious/img/icon/phone-ic.svg') }}" alt="" class="c-header__mailic"> {{ $phone }}
                    </a>
                    <a href="mailto:{{ $email }}">
                        <img src="{{ asset('themes/victorious/img/icon/email-ic.svg') }}" alt="" class="c-header__mailic"> {{ $email }}
                    </a>
                </div>
                <div class="c-header__social">
                    ...
                    <ul class="c-header__social--list">
                        ...
                        <li class="c-header__social--item">
                            <a href="{{ $fb }}"><img src="{{ asset('themes/victorious/img/icon/fb-ic.svg') }}" alt="Facebook"></a>
                        </li>
                        @endif
                        @if($ig = setting('social_instagram'))
                        <li class="c-header__social--item">
                            <a href="{{ $ig }}"><img src="{{ asset('themes/victorious/img/icon/ins-ic.svg') }}" alt="Instagram"></a>
                        </li>
                        @endif
                        @if($yt = setting('social_youtube'))
                        <li class="c-header__social--item">
                            <a href="{{ $yt }}"><img src="{{ asset('themes/victorious/img/icon/ytb-ic.svg') }}" alt="Youtube"></a>
                        </li>
                        @endif
                    </ul>
                </div>
            ...
            <div class="details l-container">
                <ul class="c-header__main--left">
                    ...
                    <li class="flex-ic room-categories__cabin-dropmenu">
                        <a href="#">about victorious</a><img src="{{ asset('themes/victorious/img/icon/down-ic.svg') }}" alt="">
                        <ul class="cabin-menu">
                ...
                <a href="/" class="c-header__logo">
                    <img src="{{ $logo }}" alt="VICTORIOUS">
                </a>
                <ul class="c-header__main--right">
                    <li class="flex-ic room-categories__cabin-dropmenu">
                        <a href="/itineraries">itineraries</a><img src="{{ asset('themes/victorious/img/icon/down-ic.svg') }}" alt="">
                        <ul class="cabin-menu">
        ...
        <div class="main-header__mobile-menu" id="mobileMenu">
            ...
            <div class="main-header__mobile-menu-content">
                <button class="main-header__mobile-close" id="mobileMenuClose">
                    <img src="{{ asset('themes/victorious/img/icon/close-ic.svg') }}" alt="">
                </button>
                    ...
                    <li class="mobile-nav__item mobile-nav__item--has-sub">
                        <div class="mobile-nav__link-wrap">
                            ...
                            <button class="mobile-nav__toggle-btn">
                                <img src="{{ asset('themes/victorious/img/icon/arrow-right-ic.svg') }}" alt="">
                            </button>
                        </div>
