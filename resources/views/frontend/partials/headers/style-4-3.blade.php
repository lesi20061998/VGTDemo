...
<header class="shadow-sm relative z-50" style="background-color: {{ $headerBg }}; color: {{ $headerText }};">
    <div class="container mx-auto px-4">
        <div class="text-sm bg-gray-100 py-1 text-center">Top banner text</div><div class="flex justify-between items-center py-4">            {{-- Logo --}}
            ...
            </div></div><div class="bg-blue-600 text-white py-2">            {{-- Navigation Menu --}}
            @if($navMenu?->items)
