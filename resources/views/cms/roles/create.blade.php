...
<div class="bg-white rounded-lg shadow-sm p-6">
    <div class="mb-6 flex items-center justify-between">
        <h2 class="text-lg font-medium text-gray-900">Thông tin Vai trò</h2>
    ...
    <form action="{{ request()->routeIs('superadmin.*') ? route('superadmin.roles.store') : route('project.admin.roles.store', request()->route('projectCode')) }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="number" name="level" value="{{ old('level', 5) }}" min="1" max="10" required
