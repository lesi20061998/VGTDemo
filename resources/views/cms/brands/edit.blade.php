...
<div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6" x-data="brandForm()">
    <form method="POST" action="{{ route('project.admin.brands.update', [request()->route('projectCode'), $brand->id]) }}" enctype="multipart/form-data">
        @csrf @method('PUT')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <x-quill-editor name="description" :value="old('description', $brand->description)" height="200px" />
                    @error('description')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3" 
                                      ...
                                      maxlength="500" placeholder="Mô tả ngắn gọn về thương hiệu cho kết quả tìm kiếm">{{ old('meta_description', $brand->meta_description) }}</textarea>
