            ...
            <nav class="mt-6 px-3">
                ...
                <div class="mb-4">
                    <div class="dropdown-parent">
                        ...
                        <div class="dropdown-menu ml-4 space-y-1 max-h-0 overflow-hidden transition-all duration-300">
                            <a href="{{ isset($currentProject) ? route('project.admin.posts.index', $currentProject->code) : '#' }}" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 {{ request()->routeIs('project.admin.posts.*') ? 'bg-[#98191F] text-white' : '' }}">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path>
                                </svg>
                                <span class="text-sm nav-text">Bài viết</span>
                            </a>
                            <a href="{{ isset($currentProject) ? route('project.admin.pages.index', $currentProject->code) : '#' }}" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 {{ request()->routeIs('project.admin.pages.*') ? 'bg-[#98191F] text-white' : '' }}">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                            ...
                            <a href="{{ isset($currentProject) ? route('project.admin.media.list', $currentProject->code) : '#' }}" class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 {{ request()->routeIs('project.admin.media.*') ? 'bg-[#98191F] text-white' : '' }}">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mb-4">
                    <div class="dropdown-parent">
                        ...
                        <div class="dropdown-menu ml-4 space-y-1 max-h-0 overflow-hidden transition-all duration-300">
                            {{-- Đánh giá khách hàng --}}
                            <a href="{{ isset($currentProject) && $currentProject ? route('project.admin.reviews.index', $currentProject->code) : '#' }}"
                               class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 {{ request()->routeIs('project.admin.reviews.*') ? 'bg-[#98191F] text-white' : '' }}">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
                                </svg>
                                <span class="text-sm nav-text">Đánh giá</span>
                            </a>
                            {{-- Form liên hệ --}}
                            <a href="{{ isset($currentProject) && $currentProject ? route('project.admin.form-submissions.index', $currentProject->code) : '#' }}"
                               class="flex items-center px-4 py-2 text-slate-400 hover:bg-[#98191F] hover:text-white rounded-lg transition-all duration-200 {{ request()->routeIs('project.admin.form-submissions.*') ? 'bg-[#98191F] text-white' : '' }}">
                                <svg class="h-4 w-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                </svg>
                                <span class="text-sm nav-text">Form liên hệ</span>
                            </a>
                    ...
                    <div class="mb-4 p-4 rounded-lg {{ session('alert')['type'] === 'error' ? 'bg-red-100 border border-red-400 text-red-700' : (session('alert')['type'] === 'warning' ? 'bg-yellow-100 border border-yellow-400 text-yellow-700' : 'bg-green-100 border border-green-400 text-green-700') }}" 
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                ...
                                @endif
                                <span class="font-medium">{{ session('alert')['message'] }}</span>
                            </div>
