...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <h2 class="text-lg font-semibold text-gray-900 mb-6">Thông tin đánh giá</h2>

        <form method="POST" action="{{ route('project.admin.reviews.store', $projectCode) }}" class="space-y-5">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="reviewer_title" value="{{ old('reviewer_title') }}"
                           placeholder="VD: Giám đốc Công ty ABC"
            ...
            <div>
                ...
                <input type="text" name="reviewer_avatar" value="{{ old('reviewer_avatar') }}"
            ...
            <div>
                ...
                <textarea name="content" rows="4"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 @error('content') border-red-500 @enderror">{{ old('content') }}</textarea>
