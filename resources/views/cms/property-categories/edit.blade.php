...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600">Cập nhật thông tin danh mục "{{ $property_category->name }}"</p>
        </div>
        <a href="{{ isset($currentProject) && $currentProject ? route('project.admin.property-categories.index', $currentProject->code) : route('cms.property-categories.index') }}" 
    ...
    <!-- Form -->
    <form method="POST" action="{{ isset($currentProject) && $currentProject ? route('project.admin.property-categories.update', [$currentProject->code, $property_category->id]) : route('cms.property-categories.update', $property_category->id) }}" 
          class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden" 
          x-data="{ 
              image: '{{ old('image', $property_category->image) }}',
              updateImage(url) {
                  this.image = url;
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-0">
            ...
            <div class="lg:col-span-2 p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="slug" 
                                   value="{{ old('slug', $property_category->slug) }}" 
                        ...
                        <div>
                            ...
                            <select name="parent_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                ...
                                @foreach($parentCategories as $parent)
                                    <option value="{{ $parent->id }}" {{ old('parent_id', $property_category->parent_id) == $parent->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   name="sort_order" 
                                   value="{{ old('sort_order', $property_category->sort_order) }}" 
                                   min="0" 
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <div>
                    ...
                    <x-quill-editor name="description" :value="old('description', $property_category->description)" height="200px" />
                    @error('description')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="meta_title" name="meta_title" value="{{ old('meta_title', $property_category->meta_title) }}" 
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3" 
                                      ...
                                      maxlength="500" placeholder="Mô tả ngắn gọn về danh mục cho kết quả tìm kiếm">{{ old('meta_description', $property_category->meta_description) }}</textarea>
            ...
            <div class="lg:col-span-1 bg-gray-50 p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        @include('cms.components.media-manager', ['slot' => $property_category->image ? 'Thay đổi hình ảnh' : 'Chọn hình ảnh từ thư viện'])
                ...
                <div>
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" 
                               name="is_active" 
                               value="1" 
                               {{ old('is_active', $property_category->is_active) ? 'checked' : '' }} 
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('property_category edit page loaded');
