...
@section('title', 'Thêm Feature Pack | Super Admin')
@section('page-title', 'Thêm Gói Tính Năng')
...
<div class="px-6 py-8 w-full max-w-4xl mx-auto">
    <div class="mb-6 flex items-center">
        ...
        <div>
            <h1 class="text-3xl font-bold text-[#001B4E]">Thêm Feature Pack Mới</h1>
            <p class="text-gray-500 mt-1">Tạo một gói tính năng mới cho hệ thống</p>
        </div>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('superadmin.feature-packs.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full rounded-lg border-gray-300 focus:border-[#001B4E] focus:ring focus:ring-[#001B4E] focus:ring-opacity-50 shadow-sm" 
                              placeholder="Mô tả chi tiết về tính năng này...">{{ old('description') }}</textarea>
